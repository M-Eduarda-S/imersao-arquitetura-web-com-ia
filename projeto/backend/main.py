...
figurinhas = [
    ...
    {"id": 30, "nome": "Maria Eduarda Santos",  "categoria": "Alura",           "imagem_url": "/figurinhas/30/imagem"},
]
...
# Endpoint único GET "/figurinhas/{id}/imagem" que devolve a imagem da figurinha
